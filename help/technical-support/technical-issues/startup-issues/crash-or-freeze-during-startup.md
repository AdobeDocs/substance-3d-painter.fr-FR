...
breadcrumb-title: ''
description: Découvrez comment corriger les crashs et les blocages au démarrage de Substance 3D Painter pour un lancement stable de l’application.
helpx_creative_field: ""
helpx_description: Painter > Technical support > Technical Issues > Startup Issues > Crash or freeze during startup
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Crash ou blocage au démarrage
...
L’utilisation d’anciens pilotes GPU peut entraîner des blocages et/ou des crashs. Nous vous recommandons d’utiliser les derniers pilotes GPU lorsqu’ils sont disponibles. Voir : [Le GPU a des pilotes obsolètes](../gpu-issues/gpu-has-outdated-drivers.md).
...
* Certaines fenêtres de l’application ont été ouvertes sur un autre moniteur. Restaurer l&#39;interface à sa disposition par défaut permet de démarrer l&#39;application normalement :
  ...
  1. Accédez aux préférences de l&#39;application (voir : [Préférences et emplacement des données de l&#39;application](https://helpx.adobe.com/substance-3d/unlisted/documentation/spdoc/application-preferences-location-147095594.html)).
...
## Crash en raison d’un chemin système/chemin Python incorrect

L’application vérifie le chemin système pour charger les modules Python et les paramètres d’environnement. Si la configuration du système est incorrecte, un crash peut se produire au démarrage.
...
Vous pouvez ensuite modifier la variable pour vérifier son contenu. Par exemple, si la variable contient ce type de caractères suivants, elle conduira à un crash
...
## Crash au démarrage sur les anciennes versions

Sous Windows, la version 2018 (4.x) ou antérieure peut ne pas démarrer car l’un des fichiers DLL fournis avec le dossier d’installation est trop ancien pour le système d’exploitation. Ce crash peut être corrigé en remplaçant manuellement le fichier par une version plus récente.
