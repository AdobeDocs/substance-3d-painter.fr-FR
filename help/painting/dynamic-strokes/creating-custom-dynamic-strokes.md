...
* Utilisation d’une ressource de Substance existante pour créer un pinceau/paramètre prédéfini d&#39;outil
...
Recherchez dans l&#39;Étagère des ressources compatibles qui peuvent répondre à vos besoins, puis consultez notre page sur les [Paramètres prédéfinis](../presets/presets.md).

## Création de fichiers de Substance personnalisés pour les Traits dynamiques

Vous trouverez ci-dessous une liste des paramètres pris en charge pour les Traits dynamiques dans les graphes de Substance.

| Identifiant variable | Description |
| --- | --- |
| <b>Générateur aléatoire</b> | Si un fichier de Substance est cuit avec la valeur Générateur aléatoire exposée, il sera contrôlable avec la fonction Contour dynamique. |
...
| <b>stampCycleCount</b> | <b>Entier 1</b> Painter lit les valeurs minimale, maximale et par défaut du paramètre pour exposer le paramètre Nombre de cycles de tampon. Ce paramètre contrôle le nombre de variations de Substance uniques qui seront créées. |
| <b>$time</b> | <b>Flottant1</b> sera alimenté par Substance 3D Painter lors de la peinture du contour en fonction du temps de peinture écoulé (par contour). Cette propriété peut générer de nombreuses variations de Substance et donc avoir un impact sur les performances. |
| <b>strokeSpacing</b> | <b>float1</b> Valeur d&#39;espacement courante pour l&#39;ensemble du contour peint. |
| <b>strokeSize</b> | <b>float1</b> La valeur de taille actuelle pour l’ensemble du contour peint. |
| <b>stampStrokePosition</b> | <b>entier 1</b> utilisé pour spécifier le début/le début d&#39;un trait. La valeur de fin est uniquement disponible sur le tracé, et non via la peinture manuelle. Valeur possible :<ul data-preserve-html="true"> <li data-preserve-html="true">0 = milieu</li> <li data-preserve-html="true">1 = début</li> <li data-preserve-html="true">2 = fin</li> </ul>Peut être désactivé à l’aide de la balise utilisateur isstrokepositionactive. |
...
| <b>pathCorner</b> | <b>entier 1</b> Indiquez le type d&#39;angle utilisé par un ruban. Valeur possible :<ul data-preserve-html="true"> <li data-preserve-html="true">0 = Aucun coin</li> <li data-preserve-html="true">1 = Coin gauche</li> <li data-preserve-html="true">2 = Coin droit</li> </ul> |
