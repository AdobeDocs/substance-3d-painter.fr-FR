...
helpx_learn_topic: ""
helpx_tags: ""
title: Création de particules prédéfinies
...
# Création de particules prédéfinies

Le système de particule qui permet de mettre en peinture des particules utilise **PopcornFX** qui s&#39;appuie sur des fichiers **.pkfx** pour définir les comportements.

Les pinceaux de particule se composent de deux parties : l&#39;**Émetteur** et le **récepteur**, qui sont enregistrées ensemble dans le paramètre prédéfini. L’application charge l’Émetteur et remplace les événements de collision pour émettre le récepteur lors de la peinture.
