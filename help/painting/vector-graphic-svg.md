---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-painter/painting/vector-graphic-svg.html"
breadcrumb-title: ''
description: Découvrez comment utiliser des images vectorielles (SVG et fichiers AI) dans Substance 3D Painter pour ajouter des illustrations vectorielles évolutives à des textures.
...
# Image vectorielle (.svg et .ai)

![Image montrant un fichier svg projeté sur un maillage à côté d’une liste de paramètres](../assets/svg_overview.png)

Les fichiers d&#39;Image vectorielle (à la fois <b>.svg</b> et Illustrator <b>.ai</b>) peuvent être importés comme des images normales dans Painter. Quelques paramètres sont disponibles pour ajuster l’aspect de l’image et mieux l’adapter au reste de la texture.
...
|  | Format carré | Si la zone de recadrage est définie par des <b>limites d&#39;actifs</b>, ce paramètre permet de s&#39;assurer que le rapport d&#39;origine est conservé, évitant ainsi tout étiré incorrect lors du rendu du SVG sous la forme d&#39;une image carrée.   Ce paramètre peut rendre certains éléments visibles de manière inattendue. Pour éviter ce problème, désactivez ce paramètre et ajustez plutôt les paramètres d’UV manuellement à l’intérieur d’un calque de remplissage/effet. |
