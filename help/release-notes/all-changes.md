...
* [Crash] Un enregistrement avec un espace disque insuffisant peut entraîner le crash ou la corruption de projets
* [Crash] [Ruban] L’utilisation du ruban peut entraîner des crashs pour certains projets
* [Crash] [Baking] crash lorsque le fichier .assbin ne peut pas être écrit dans le dossier
* [Importer] Les maillages OBJ à partir de Stager peuvent échouer lors de la création du projet
* [Importer] Dans certains cas, la face d’OBJ est manquante
* [Importer] Un maillage USD sans matériau affecté peut créer un crash lors de l’importation
* [Tracé rempli] Non affecté par la symétrie
* [Pochoir] La résolution de l’aperçu est inférieure au résultat peint
* [UI] « île uv » est toujours mentionnée dans l’info-bulle de la source de couleur du Map id
* [Affichage] Les ombres apparaissent inversées
* [Viewport] Le transforme de projection de déformation reste après le passage en mode baking
* [Déformation] La Grille disparaît lorsque l’échelle est définie sur 0 à l’axe Z avec l’option Déformation de la géométrie activée
...
* \[Crash\]\[Geler\] Exporter à partir de projets spécifiques
...
* [Aplatir les calques] Aplatir les calques à l’intérieur de la pile de calques
...
* [Projet] Impossible d&#39;effectuer une peinture sur une géométrie
* [Ruban] Le chemin Instancié disparaît lorsque la résolution du Jeu de textures est modifiée
...
* [Baking] Amélioration du temps de baking pour les projets de Tuiles UV avec enregistrement asynchrone
...
* [Crash] L’utilisation du sélecteur de couleurs sur différents Jeux de textures peut entraîner un crash lors de la fermeture de l’application
...
* [UI] Les paramètres de Caméra restent désactivés en mode de rendu (Iray)
...
* [Baking][UI] Impossible de définir le rayon d’échantillonnage de la Courbure au-delà de 0,01
* [Baking][UI] Impossible de définir une Distance d&#39;occlusion maximale supérieure à 1
* [Baking] Le paramètre AO « Auto-occlusion » est ignoré avec plusieurs Jeux de textures et Faible comme baking élevé
* [Baker] Map id ne bake pas les couleurs vertex FBX en mode Faible ou Élevé
...
* [Dépliage automatique] Mise à jour vers la version 1.3.2 avec des améliorations de couture
* [USD][FBX] Prise en charge supplémentaire de plusieurs Ensembles d&#39;UV avec des données fragmentées
* [Export] Les Maillages exportés en tant que FBX ne disposent pas de leurs Ensembles d&#39;UV supplémentaires s&#39;il en existait lors de l&#39;importation

<b>Fixe</b> :

* crash [MacOS][Linux] lors de l’enregistrement sur un lecteur réseau
* [Win][Tablette] Scintillement lors du panoramique
* [SpaceMouse] Problème lors de l’utilisation de l’outil Chemin
* [cage automatique] Impossible de baker après un rechargement de maillage
* [Mise à jour automatique] La séquence d’images n’est pas rechargée lorsque la première vignette est manquante
* [Chemin] La tangente personnalisée peut affecter d’autres tangentes
* [Tracé] Le tracé n’apparaît pas sur le Jeu de textures si le premier point se trouve sur un autre Jeu de textures
* [UI] Certains menus sont toujours désactivés après l’ouverture d’un projet (par exemple : symétrie)
* [Propriétés] Impossible d’utiliser/de charger des paramètres prédéfinis d&#39;outil avec l’outil Chemin rempli
* [USD] Les Ensembles d&#39;UV multiples ne sont pas reconnus dans le shader personnalisé lors de l’utilisation de fichiers USD
...
* [Crash] Lors du glisser-déposer d’un fichier sbsar avec une utilisation dans un emplacement de canal unique
* [Crash][Chemin] L’option Modifier le type de chemin n’est pas grisée lorsque vous ne cliquez pas sur un chemin spécifique
* [Chemin de remplissage] Ne doit pas pouvoir sélectionner le matériau Substance
* [Moteur] Artefacts le long des coups de pinceau
* [Moteur] Les tracés peuvent être rompus avec des paramètres spécifiques
...
* Le contraint angulaire doit être affecté par la sélection d’objet/d’Espace monde
...
* [Baking] Correction d’une copie ambiguë dans le menu contextuel des Maps de maillage
* [Déformation] Supprimer la mise à l’échelle en viewport pour l’axe Z (profondeur)
...
* [Crash] Après avoir redéfini l&#39;emplacement la ressource dans Assets et enregistré le projet
* [Crash] Problèmes avec la bibliothèque aiserver
* [Crash] crash du serveur Illustrator dans de rares cas
* [Crash] Lorsque vous quittez l’application dans de rares cas
* Impossible d&#39;envoyer des rapports de crash sur certains ordinateurs
* [Baking] La couleur du Vertex n’est pas lue correctement
* [UI] L’emplacement des fenêtres et les Nouveautés au démarrage sont modifiés.
* [Assimp] Maya&#39;s StandardSurface non reconnue dans le baking ID
* [Python] La bibliothèque SSL manquante génère une erreur
* [Python][Win] Erreur lors de l’appel de QColorConstants.Transparent
* [Python] Les miniatures de calques créées via Python ne sont pas actualisées avant d’avoir cliqué dans la pile de calques
* [Shader] Lien rompu dans le changelog de API de shader
...
* Divers
* [projection de remplissage] Amélioration du comportement du manipulateur d’échelle lors de l’utilisation de petites valeurs
...
* [Crash] Annulation de « Supprimer l’instance de shader » avec Ctrl-Z
...
* [Dépliage automatique] Recalculer uniquement le packing sans modifier l’orientation de l’UV entraîne un crash
...
* [Performance] Les UV masqués sont toujours calculés
...
* [USD] Prise en charge de la commande de maillages de vertex pour gauchers
...
* [Moteur] Les coups de pinceau de Map normal se cassent après une annulation
* [Contenu] La simulation de transparence et l’espace colorimétrique du graphique par Filtre de matériau sont incorrects
...
* [Contenu] L’éclairage Baké stylisé ne prend pas en compte l’height peint
* [Python] Erreur inattendue lors de la récupération des informations de calque instanciées après un changement de shader
...
* [Performance] Amélioration du temps de création du premier calque de remplissage dans les nouveaux projets
* [Performances] Réduction du temps de chargement des maps d&#39;environnement lourdes
* [Substance] Autoriser l’enregistrement/la fermeture de projets même lorsque des vignettes sont générées

<b>Fixe</b> :

* L’enregistrement échoue sur les projets de version précédente lorsque le viewport est modifié
* [Crash] Réimportation du maillage lors de l’utilisation de l’AO personnalisé et de la gestion des couleurs
* [projection de remplissage] Cliquer sur le manipulateur d’échelle donne un message « non à peindre »
* [Pinceau] La peinture avec un alignement UV provoque des artefacts
* [Pile de calques] Le changement de nom du calque est lent lorsque la pile est très longue
...
* [Export] La Texture alpha n&#39;est pas générée avec le paramètre prédéfini d&#39;exportation vue 2D
* [Export] L&#39;exportation SBSAR a des utilisations incorrectes avec des mappages convertis
* [Shader] Le journal des modifications de API de shader n’est pas à jour avec les dernières modifications d’ASM
...
* [Interop] Autoriser l’envoi d’un maillage texturé à After Effects (Ae 24.1)

<b>Fixe :</b>

* [Fond] La projection Ensemble d&#39;UV à Ensemble d&#39;UV ne lit pas plus de 2 Ensembles d&#39;UV
* [Crash] Utilisation de la map d&#39;environnement 16K
* [Crash] Exr utilisé comme entrée d’image
* [Crash] Copier et coller des tracés entre les projets
* [QoL] Le glisser-déposer d’Alpha en mode décalcomanie crée une Projection UV dans le masque
* [Chemin] La copie des vertex de chemin renomme également le chemin cible lors de la réouverture du projet
...
* [Mode Baking] Ajouter (vide) du raccourci pour afficher/masquer la visualisation du viewport
* [Mode Baking] Toujours afficher le poly faible lors de l’utilisation du bouton « Masquer les maillages de baking »
* [Mode de Baking] Afficher le suffixe pour la correspondance par nom en fonction du Jeu de textures actuel
* [Importer] Ajout de la prise en charge des fichiers binaires GLTF (glb)
* [Liste de Jeux de textures] Menu Ajouter pour sélectionner ou créer des instances de shader
* [Liste de Jeux de textures] Permet de modifier rapidement la résolution des Jeux de textures et des Tuiles UV
* [Taille physique] Amélioration du comportement du manipulateur lors de l’utilisation de la taille physique dans Projection UV
...
* [Python] Ajouter des événements de baking pour suivre la progression du Baking
* [Python] Autoriser l&#39;annulation d&#39;un baking
* [Python] Exposez « En fonction du modèle de sortie » pour le type de fichier et la profondeur de bit lors de l’exportation.
* [Python] Exposer l&#39;heure d&#39;actualisation pour TextureStateEvent.Update

<b>Fixe :</b>

* [Crash] Rare crash lors de la fermeture d’un projet
* [Crash] [Baking] Activer la synchronisation des maps de maillage avec l’Height ou la courbure sur un projet spécifique
* [Crash][Script] Crash lors de l’ajout d’un matériau après la création de l’instance de shader
* [Mode Baking] L’intensité AO en matériau neutre n’a aucun effet
...
Résumé : **version majeure. Introduction de la 1ère version de la gestion des couleurs, désancrage de la vue 2D ou 3D, nouvelle option d&#39;UV automatique pour éviter les îlots allongés, appel des fonctions JavaScript à partir de l&#39;API Python et nouveau contenu**
...
* [Performances] Ne calculez pas toutes les Tuiles UV lors de l’utilisation de la sélection d’ID de couleur
* [Bakers][UI] Afficher les descriptions de Jeu de textures
* [Bakers] Autoriser à enregistrer les paramètres de baking
* [Bakers] Ajout des options Réduire tout/Développer tout à l’onglet Sélection
* [Liste de Jeux de textures] Masquer la description lorsqu’elle est vide
* [Tuiles UV][Liste de Jeux de textures] Cliquer sur la Tuile UV doit développer/réduire la liste
* [Exporter][Interface utilisateur] Autoriser le redimensionnement horizontal du panneau Liste des Jeux de textures
...
Résumé : **version estivale, prise en charge des subsurfaces scatterings, améliorations des projections et du remplissage, importation et sélection de caméras, prise en charge d’Alembic et de glTF, glisser-déposer sur le Map id, prise en charge améliorée du format de Substance et nouveau contenu**
...
* [Moteur] Pas ou moins de discontinuités entre les UV
...
* [Linux] Les entrées des tablettes Wacom ne fonctionnent pas en 3D et en Vue 2D
* Dans certains cas, les Particules [Mac] peuvent entraîner une corruption des textures
...
* [Plug-in] En raison de Photoshop, l’height et le canal normal ne peuvent pas être translatés tels quels
...
* [Viewport] Ajouter un raccourci « B » pour passer d’une carte à l’autre
...
* [Iray] Augmenter le nombre maximum d’échantillons et le temps de rendu
...
* [Exporter] N’exportez pas de canal Alpha pour les textures uniquement RGB
* [Export] Mise à jour du paramètre prédéfini d&#39;exportation Dota 2
* [Étagère] Nouveau motif « carreaux hexagonaux »
* [Étagère] Nouvel outil « Soudure »
* [Étagère] Filtres de finition mis à jour pour les commandes de direction
...
* crash [Iray] lors de la détection de matériel
* [Outil] La couleur d’aperçu du pinceau est incorrecte en mode Masque
* [Outil] Le sélecteur de Matériau peut être utilisé avec des outils incompatibles
* [Outil] L’aperçu des Projections ne passe pas en mode Diffuse avec le workflow Spécification/brillance
* [Étagère] La modification du shader par défaut casse les aperçus de cache/masque adaptable dynamique
* [Étagère] Certains matériaux adaptables ont des noms incorrects
* [Étagère] Les formes alpha supplémentaires sont corrompues et ne se chargent pas
* [Viewport] Le passage en mode « Mappage supplémentaire » affiche « autre » en premier
* [Viewport] Le Viewport revient à « autre » lorsqu’il n’existe pas de mappage supplémentaire
* [Crash][Linux] Le rapport de Crash ne fonctionne pas sur Ubuntu (Steam)
* [Crash][Linux] Les liens URL web ne fonctionnent pas sur Ubuntu (Steam)
* [Crash][Windows] Supprimer « crashwatcher » lorsque Substance painter ne fonctionne plus
* [Crash][Mac] Le système de rapports de Crash ne fonctionne pas correctement
* [Crash] L&#39;importation d&#39;un maillage alors qu&#39;un maillage est déjà importé conduit à un crash
* Jeu de textures de sélection du raccourci réinitialisé à rien après un redémarrage
...
* [UDIM] Importation de Tuiles UDIM d’un maillage sous forme de Jeux de textures
...
* [Baker] Permet de baker plusieurs jeux de textures à la fois
...
* Crash avec Processeur de pixels pendant certains calculs
...
* Raccourci vers Substance Store dans la barre d’outils principale
* Moteur de rendu d’Iray avec mode d’affichage et exportation de capture d’écran
* Prise en charge de la création et de l’utilisation de « Masques adaptables »
...
* Basculer la résolution d’aperçu Pochoir/Projection sur 2K
...
* [Outil] Nouvel outil de Clone pour copier une partie des textures
* [Outil] Autoriser à sélectionner des canaux pour les outils Doigt, Clone et Gomme
...
* [Viewport] Basculer entre les modes perspective et orthographique
* [Viewport] Autoriser à contrôler le Champ de vision en mode perspective
* [Viewport] Autoriser à définir la Profondeur de la distance de champ avec CTRL+clic du milieu
* [Viewport] Permet de faire glisser et de déposer des maps d&#39;environnement dans la vue 3D.
* [Viewport] Amélioration des commentaires lorsque le moteur effectue des calculs forts
* [Export] Autoriser à exporter les paramètres de shader dans un fichier json
...
* [Étagère] Prise en charge de la hiérarchie des sous-étagères dans un dossier d’étagère

**Fixe :**

* Crash lors de l’enregistrement sur un fichier en lecture seule précédent
* Crash lors de l’ouverture d’un deuxième projet
* Crash lors du chargement de certaines vignettes (étagère, calques ou info-bulles)
* La désactivation de l’option « Conserver les positions des contours sur le maillage » ne fonctionne pas
* [Export] L&#39;agrandissement des bitmaps se fait avec le filtrage le plus proche
* [Étagère] La découverte des ressources est très lente
* [Étagère] Les filtres de flou ne sont pas compatibles 16 bits
* [Outil] La Symétrie ne fonctionne pas si vous chargez un ancien paramètre prédéfini d&#39;outil
...
* [Calques] Permet de spécifier le remplissage par défaut pour les calques de remplissage
...
* [Étagère] Les métadonnées sont écrites sur le disque après chaque sortie
...
* [Substance] Ajouter un nouveau framework (Améliorer les performances du Processeur de pixels)
* [Viewport] Permet de désactiver l&#39;affichage du plan de symétrie en mode symétrie.
* [Viewport] Amélioration du rendu et des performances des ombres
* [Viewport] Suspendre le calcul de l’ombre lors de la peinture
* [Viewport] Amélioration des performances de rendu structure filaire
* [Moteur] Améliorer la gestion de la mémoire Vram pour réduire son encombrement
...
* [Calque] Permet de faire glisser et déposer des Matériaux directement dans la pile de calques.
...
* [Shader] Exposer plusieurs codes textuels
* [Shader] Exposer la fonction gamma/tonemapping pour autoriser les fonctions personnalisées
* [Bakers] Modification des paramètres de baker de position par défaut pour l’utilisation TriPlanar
* [Outil] Renommez « Geometry Decal » en « Polygon Fill »
* [Étagère] Mise à jour des générateurs pour prendre en charge TriPlanar : MG Usure des bords en métal, MG Constructeur de masque, MG Fibre de verre, MG Dirt
* [Étagère] Mettez à jour les matériaux avec de nouveaux paramètres et supprimez les matériaux inutilisés
...
* [Étagère] Automatisation de la génération des vignettes pour les Matériaux adaptables
...
* [Outil] Raccourci pour inverser la couleur de la peinture tout en peignant sur une carte en niveaux de gris
* [Viewport] Permet d’afficher la structure filaire et de modifier sa couleur
* [Viewport] Flouter l’arrière-plan de l’environnement
...
* [Calques] Crash lors de l’utilisation du masque Effacer
...
* [Outil] Crash lors de l&#39;utilisation de la décalcomanie géométrique avec le masque rapide
...
* Les étagères personnalisées analysent la hiérarchie entière et dupliquent les actifs partout
...
* [Viewport] Autoriser l’ancrage côte à côte des panneaux
...
* [Étagère] La génération des vignettes est interrompue si aucun projet n’est ouvert.
* [Étagère] Échec de la génération de l&#39;aperçu du Paramètre prédéfini de matériau
* [Étagère] Les aperçus de Matériau sont générés sur un maillage avec des normales inversées
* [Étagère] Les vignettes sont toujours recalculées en raison d’une fonction de hachage incorrecte
* [Étagère] Cliquer sur un matériau Substance ne connecte pas les cartes supplémentaires
* [Outil] Valeur incorrecte échantillonnée avec le sélecteur de Matériau
* [Outil] Couleur du curseur du viewport de sélection de couleur
* [vue 2D] Très faible fréquence d’images/performances
* crash [Export] lors de l’ouverture de la fenêtre d’exportation avec des paramètres prédéfinis d’exportation trop récents.
* [Export] La couche Height vers la Map normal est convertie dans un espace incorrect
...
* [Étagère] Les fichiers de ressources sont écrits dans Painter s’ils ont été utilisés dans le projet.
...
* [Matériau] Le Diffuse remplace le mappage Couleur de base avec les substances
* [vue 3D] Éclairage de Diffuse incorrect avec des cartes d’environnement spécifiques
* [Outil] Impossible de faire pivoter un pinceau selon un angle spécifique
* Le viewport est activé lors du survol lors de la saisie dans un champ de texte
* Crash avec des paramètres prédéfinis trop récents pour la version actuelle de l’étagère
* Crash après avoir remplacé le maillage
* Crash lors du rechargement d’une substance avec un nombre d’entrées différent
* maillages FBX de l’importation Cinema4D avec des noms de matériau incorrects
...
* [Mac] Crash lors du chargement de fichiers FBX spécifiques
* [Mac][vue 3D] Reflet incorrect pour le GPU intégré
* [vue 3D] La police du Masque rapide est endommagée
* [vue 3D] Le sélecteur de Matériau rend le viewport totalement noir
* Crash après ouverture des projets créés dans la version 1.3.3
* l’aperçu par matériau est vide lors de l’utilisation de shaders avec alpha
...
* [Outil] Amélioration de l’utilisation des paramètres de Matériau
* Nouveau raccourci du site web uservoice dans le menu Aide
* Différentes améliorations de performances dans le moteur
...
* Crash lors du chargement d’un maillage à partir d’une url réseau
...
* Prise en charge du Shader personnalisé
...
* Aperçu de l’outil (zone séparée d’aperçu du matériau en temps réel et de test de contour)
...
* Outil Pipette
* L’option « Conserver la position du contour » a été ajoutée à la réimportation du maillage lorsque le cadre de sélection change.
* Map normal pour le maillage par défaut de Cymourai
...
* Calque de remplissage : augmenter la valeur de répétition maximale
* Map d&#39;environnement par défaut
...
* Crash avec OSX Yosemite
* Les maillages sont enregistrés et triangulés
* Le raccourci de couleur de la fenêtre Outil est envoyé à l’émetteur au lieu des niveaux de gris
* Le sélecteur de couleurs reste ouvert lors du passage d’un calque à un masque
* Impossible d’enregistrer le matériau d’un calque de remplissage
* Activer le redimensionnement des trois zones de l’étagère
...
* La plupart des matériaux de substance sont plafonnés à 256 dans la version Beta 9
...
* L’utilisation de l’outil Géométrie pour créer un masque ne s’affiche pas dans les viewports
* Le masque rapide est cassé
...
* Plusieurs crashs GPU
* Crash lors de l’exportation de canaux
...
* Matériaux multiples : vous pouvez désormais effectuer une peinture sur plusieurs matériaux dans le même document
* peinture sur symétrie
...
* Effets de calque
* Nouveaux matériaux de Pochoir de Substance
* Effacer le masque
...
* Ajout d’autres pochoirs dans la bibliothèque de pochoirs
* Particules prédéfinies mises à jour pour un calcul plus rapide
* Optimisation du shader PBR et amélioration de la qualité pour les paramètres de qualité inférieure
...
* Autoriser les valeurs négatives dans le sélecteur de couleurs pour la peinture sur map height
* Afficher l’aperçu du matériau/de la couleur sélectionné
...
* Le curseur Espacement n’est plus serré
...
* Fixe : l’importation du chemin de maillage n’est pas conservée
* Correction : génération de textures incorrecte
* Fixe : Crash au démarrage
...
* Style des curseurs mis à jour
* Mise à jour de l’environnement HDR par défaut

**Fixe :**

* Pochoir : modifier la valeur du flux dans la vue 3D s’arrête à 52
* La boucle infinie dans le moteur lors de l’ajout de touches de pression 0 au contour est fixe
* Outil : la variation d’angle ne renvoie pas de valeurs supérieures à +/- 90 %
* Modification de l’affichage vue 3D lorsqu’un masque de fusion est sélectionné
* Zoom inversé
...
* Nouveau contenu de pinceaux et de Particules
