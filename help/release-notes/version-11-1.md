...
<b>Substance 3D Painter 11.1 </b>apporte le nouvel outil de Tracé de ruban avec du contenu dédié, des symétries sur les calques de remplissage et les effets, la taille physique pour le displacement et la prise en charge de l&#39;API graphique Vulkan.

Date de publication : <b>18 novembre 2025</b>

>[!NOTE]
>
> Cette version de Painter remplace l’API graphique OpenGL par Vulkan. Cette modification peut avoir un impact sur les GPU pris en charge par l’application, notamment pour le baking avec un raytracing basé sur le GPU.
> 
...
Le <b>Tracé de ruban</b> est un nouvel outil de la famille d&#39;outils de tracé. Un ruban transforme et répète une texture le long d’un tracé sans aucune découpe, avec un contrôle supplémentaire pour le début et la fin, ainsi que des options pour les coins nets.

Ce nouvel outil permet d’appliquer de nouveaux comportements, tels que le placement de texte le long d’un tracé, le placement d’un dégradé parfait le long d’un tracé et la création facile de vos propres raccords avancés pour habiller un maillage.\
...
* <b>Le ruban est un tracé continu qui fonctionne sur toutes sortes de surfaces</b>\
  ItLe ruban est un outil qui permet de répéter ou de étirer une texture le long d’un tracé. Il fonctionne sur tous les types de surfaces et de géométries, même lorsque les pièces du maillage ne sont pas connectées.

  ![](../assets/ribbon_robot_1.jpg)
* <b>Répétition de motifs et de dégradés</b>\
  Ce nouvel outil permet de répéter des images de différentes manières, sans seams ni découpes. Il convient donc aux dégradés et aux motifs nets.

  ![](../assets/ribbon_repeat_demo.png)
* <b>Étirer des images avec début et fin personnalisés</b>\
...
* <b>Différents types de coins disponibles</b>\
  Lorsque vous brisez des tangentes pour créer des angles, plusieurs formes sont disponibles en fonction des besoins : du cassage classique à l’arrondi.

  ![](../assets/ribbon_corners_small.jpg)
* <b>Commandes de Étiré et de répétition</b>\
  Les images peuvent facilement être répétées ou étirées le long d’un Tracé de ruban, automatiquement ou manuellement.
...
* <b>Compatible avec le workflow des traits dynamiques de Substance</b>\
  ...
  Deux nouveaux paramètres prédéfinis d&#39;outil nommés <b>Niveaux de gris du ruban personnalisé</b> et <b>Matériau du ruban personnalisé</b> sont également fournis pour rendre cette fonctionnalité facilement accessible.

  ![](../assets/ribbon_custom_preset.gif)
* <b>Compatible avec symétrie</b>\
...
* <b>Séparer la taille et l’opacité par vertex sur les tracés</b>\
  Il est désormais possible de régler la taille et l’opacité par vertex sur un tracé, et ces réglages ne sont plus liés au paramètre de pression. Ces deux propriétés sont désormais traitées séparément avec des curseurs dédiés dans l’interface.
...
Cette version comprend 75 nouveaux paramètres prédéfinis d&#39;outil qui tirent parti des nouvelles fonctionnalités du ruban. Pour faciliter la découverte des paramètres prédéfinis, de nouvelles catégories de paramètres prédéfinis ont été ajoutées dans la fenêtre <b>Propriétés</b>.

* <b>Raccourcis des nouvelles catégories prédéfinies dans la fenêtre Propriétés</b>\
  Une série de nouveaux boutons se trouve désormais en haut de la fenêtre <b>Propriétés</b> lors de l’utilisation d’outils de tracé. Chaque bouton donne accès à des paramètres prédéfinis d&#39;outil, triés par catégories. La catégorie des favoris regroupe les paramètres prédéfinis que vous avez choisis.

  ![](../assets/ribbon_presets_categories.png)

  En cliquant sur l’un des boutons, vous accédez rapidement à certains paramètres prédéfinis présélectionnés. Cliquez sur <b>Afficher plus dans les actifs</b> pour afficher plus de paramètres prédéfinis d&#39;outil de chemin dans la fenêtre <b>Actifs</b>.
...
* <b>Nouveau contenu</b>\
  75 nouveaux paramètres prédéfinis d&#39;outil dédiés à l’outil Ruban ont été ajoutés à cette version dans le cadre du contenu par défaut. Ces paramètres prédéfinis sont disponibles directement dans la fenêtre <b>Actifs</b> sous la section Pinceau ou via les nouveaux raccourcis de catégorie dans la fenêtre <b>Propriétés</b>.\
  Ces paramètres prédéfinis incluent :

  * <b>Vêtements</b> : amélioration des paramètres prédéfinis de plissement et de point de seam, ainsi que des fermetures éclair et des déchirures de tissu.
  ...
  * <b>Texte</b> : paramètres prédéfinis rapides pour configurer le texte le long d&#39;un tracé avec le ruban avec différents modes d&#39;alignement et de étiré.
* <b>Nouveau mot-clé d’outil pour la recherche dans la fenêtre Actifs</b>\
  Il est désormais possible de saisir « ruban », « peinture », « chemin » ou même « doigt » dans la fenêtre <b>Actifs</b>. Cela permet de rechercher des paramètres prédéfinis qui correspondent à l’outil correspondant.
...
Les calques de remplissage et les effets prennent désormais en charge la symétrie avec leurs modes de projection 3D. Il peut être activé via le menu symétrie de la barre d&#39;outils contextuelle ou via la section symétrie nouvellement ajoutée dans la fenêtre <b>Propriétés</b>.

* <b>Symétrie sur les calques de remplissage </b>\
  Lors de l’utilisation de modes de projection 3D dans les effets de remplissage et les calques, la symétrie peut désormais être activée. La symétrie radiale et la symétrie sont disponibles.

  ![](../assets/symmetry_fill.jpg)
* <b>Activer la symétrie via la barre d&#39;outils contextuelle ou la fenêtre Propriétés</b>\
  La symétrie peut être activée via le menu de la <b>barre d&#39;outils contextuelle</b>, comme les outils de peinture, ou via la fenêtre <b>Propriétés</b> avec la nouvelle section dédiée.
...
* <b>Inverser la ressource d&#39;entrée pour les textes et les logos</b>\
  La symétrie calque de remplissage et effets bénéficie également d’une nouvelle option qui permet de retourner les images d&#39;entrée ou les axes X/Y. Cela permet de refléter un texte par exemple, mais de le rendre lisible des deux côtés.

  ![](../assets/mirror_symmetry_flip.gif)
* <b>Amélioration de l&#39;interface des paramètres de symétrie</b>\
  L’interface des paramètres de symétrie a été remaniée pour être plus facile à lire et plus rapide à utiliser. Les curseurs Axes ont chacun leur propre ligne, par exemple, ce qui permet d’être plus précis. L&#39;écran radial a également été réduit pour occuper moins d&#39;espace.
...
* <b>Nouvelle option d&#39;unité d&#39;échelle dans les paramètres de displacement</b>\
  Dans la fenêtre <b>Paramètres de Shader</b>, lors du réglage de l&#39;intensité du displacement, de nouveaux paramètres d&#39;unité d&#39;échelle sont disponibles. Ce paramètre offre les options suivantes :

  * <b>Normalisé</b> : par défaut, correspond au comportement précédent de Painter. Cette taille dépend du cadre de sélection du maillage à l’intérieur du projet actif.
...
* <b>L’API graphique Vulkan est désormais utilisée à la place d’OpenGL sous Windows et Linux</b>\
  Painter utilise désormais l’API graphique Vulkan pour le rendu dans le viewport et les textures de calcul. Ce commutateur devrait améliorer les performances générales de l&#39;application. Cela facilitera également l’intégration de nouvelles fonctionnalités à l’avenir.
* <b>GPU raytracing pour baking via Vulkan</b>\
  DirectX (DRX) et Optix ont été remplacés en faveur de raytracing via l&#39;API graphique Vulkan dans nos bakers. Ce changement signifie que le raytracing basé sur le GPU est désormais disponible sur les GPU AMD ainsi que sur le système d’exploitation Linux.\
  Le passage à Vulkan améliore également les temps de rendu du baking, en particulier aux résolutions élevées.
...
* <b>Remplacement de la résolution de Substance</b>\
  Lors de l&#39;utilisation de ressources de Substance dans Outils et Calques de remplissage/effets, un nouveau groupe de paramètres <b>Résolution</b> est disponible. Ces paramètres permettent de modifier la résolution par défaut sélectionnée par l’application.\
  ...
  * <b>Résolution</b> : définissez le mode et le contexte utilisés pour calculer la résolution. La valeur par défaut est Auto, mais elle peut être définie sur <b>Jeu de textures</b> ou <b>Personnalisé</b>.
...
* <b>Améliorations des performances sur un grand triangle unique</b>\
  Jusqu’à présent, Painter se débattait avec des maillages en poly très bas ou des maillages avec des triangles très grands et/ou longs. Ce n&#39;est plus le cas. Travailler avec des maillages quad uniques, par exemple pour créer des textures de répétition, ne devrait plus être un problème.
