...
helpx_url: "https://helpx.adobe.com/fr/substance-3d-painter/release-notes/version-12-0.html"
...
* <b>Aplatir et exporter les textures sur le disque</b>\
  Une action d’exportation dédiée dans le menu contextuel bake le résultat aplati d’un calque, d’un masque ou d’un groupe et l’enregistre directement sur le disque. Cela est utile pour transférer du contenu baké vers d’autres applications sans passer par le pipeline d’exportation de texture complet.
* <b>Opérations par lots</b>\
  Plusieurs calques, groupes ou masques peuvent être sélectionnés simultanément et aplatis ou exportés individuellement en une seule opération, ce qui permet de traiter efficacement de grandes parties d’une pile de calques en une seule étape.
...
Les décalcomanies peuvent désormais s&#39;adapter automatiquement aux surfaces complexes, ce qui réduit le besoin de réglages manuels. L&#39;option <b>Déformation de la géométrie</b> est disponible dans la barre d&#39;outils contextuelle lorsque la projection Déformation est active.

* <b>Nouveau paramètre dans la barre d&#39;outils contextuelle</b>\
  Une nouvelle option de déformation en géométrie</b> est disponible dans la barre d&#39;outils contextuelle lorsque le mode de projection Déformation est activé. <b>Il peut être désactivé à tout moment sans réinitialiser la configuration de projection actuelle.

  ![](../assets/v12_warp_toolbar.png)
* <b>Habillage automatique sur la surface du maillage</b>\
...
* <b>Conservation des déformations locales</b>\
  Lors de la modification des vertex de grille de projection de déformation, la déformation en mode géométrie tente de conserver la déformation prédéfinie pour s’assurer que la même forme est toujours projetée.
...
* <b>Nouveaux effets de post-traitement</b>\
  Tous les effets de post-traitement peuvent être activés et configurés individuellement dans la fenêtre <b>Paramètres d&#39;affichage</b>. Les effets sont appliqués dans l’ordre de pile et chacun peut être activé ou désactivé indépendamment, ce qui facilite leur combinaison et leur expérimentation.

  ![](../assets/v12_display_settings_post_effects.png)
* <b>Nouvelle liste d&#39;effets :</b>

  * <b>Profondeur de champ</b> : applique un flou aux objets en dehors de la plage focale pour simuler la mise au point de l&#39;objectif de caméra.
  * <b>Fleur</b> : ajoute une lueur douce émanant des zones lumineuses de l&#39;image.
  * <b>Reflet</b> : crée des traînées de lumière autour des sources de lumière.
  * <b>Halo</b> : simule les reflets optiques de l&#39;objectif lorsqu&#39;une lumière vive brille dans la caméra.
  * <b>Aberration latérale</b> : simule la frange chromatique des contours de l&#39;image causée par les imperfections de l&#39;objectif.
  * <b>Vignette</b> : assombrit les coins et les bords du cadre pour attirer l&#39;attention vers le centre.
...
La nouvelle fenêtre de projet et la boîte de dialogue des paramètres du projet ont été repensées pour faciliter la navigation. Les paramètres ont été réorganisés et regroupés pour une meilleure lisibilité, et le flux de réimportation par maillage a été amélioré pour réduire les étapes répétitives lors de l’itération sur un projet.
...
* <b>Nouveau workflow pour la réimportation de maillages dans les paramètres du projet</b>\
  Une nouvelle case à cocher <b>Réimporter le maillage</b> dans les paramètres du projet permet de réimporter plus facilement le maillage du projet grâce au chemin du fichier précédemment chargé qui est désormais enregistré et pré-rempli automatiquement.
