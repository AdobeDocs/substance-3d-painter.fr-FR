...
Le menu Modifier permet d’accéder rapidement aux actions Annuler/Rétablir, mais aussi aux paramètres du projet et aux paramètres généraux.

| Action | Description |
| --- | --- |
| **Annuler** | Revenez un peu en arrière dans la pile [Historique](../history.md). |
