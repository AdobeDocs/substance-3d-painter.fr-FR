...
* <b>Liste des textures de sortie</b> : (au milieu) indiquez le contenu d&#39;un paramètre prédéfini sélectionné et affichez la convention de dénomination et les options de packing de canal.
* <b>Liste des canaux</b> et <b>textures converties</b> : (à droite) liste des canaux et des textures à utiliser pour composer le contenu d’une texture exportée.
...
>[!NOTE]
>
> Lorsqu’un modèle est utilisé pour exporter des textures, le fichier de modèle est automatiquement inclus dans le fichier de projet lors des enregistrements suivants.\
...
Une fois un mappage créé, vous pouvez le nommer, puis faire glisser et déposer des maps d&#39;entrée dans l’un des slots de canal disponibles.\
Une fois qu’une map d&#39;entrée a été déposée dans la section des mappages de sortie, un menu s’ouvre et vous demande quel type de contenu doit être chargé dans cet emplacement.
...
>[!NOTE]
>
> Chaque fois qu’une map d&#39;entrée est glissée et déposée, une couleur aléatoire est générée. Cela fournit un repère visuel pour les canaux et la map d&#39;entrée correspondante qui est chargée.\
...
> * Barre du RGB : indiquez que les canaux <b>R</b> , <b>G</b> et <b>B</b> de la map d&#39;entrée sont chargés.
> * Barre rouge : indique que le canal <b>rouge</b> de la map d&#39;entrée est chargé.
> * Barre verte : indique que le canal <b>vert</b> de la map d&#39;entrée est chargé.
> * Barre bleue : indique que le canal <b>bleu</b> de la map d&#39;entrée est chargé.
> * Barre de gris : indique que la map d&#39;entrée est chargée en <b>niveaux de gris</b> (d&#39;une conversion RGB en niveaux de gris ou parce que l&#39;entrée est déjà en niveaux de gris).
> * Ligne noire/blanche : indique que le canal <b>alpha</b> de la map d&#39;entrée est chargé. Dans Substance 3D Painter, la valeur alpha d’une entrée correspond à la zone peinte totale.
...
* <b> $maillage</b> : nom du fichier de maillage chargé dans le projet
* <b> $textureSet</b> : nom du jeu de textures
* <b> /</b> (barre oblique inverse) : séparation des dossiers

<b> Exemple</b> : cymourai.fbx avec un jeu de textures nommé « MaterialBase »

* <b>$maillage\_$textureSet\_BaseColor</b> générera <b>cymourai\_MaterialBase\_BaseColor.png.</b>
* <b>$maillage/$textureSet\_BaseColor</b> générera un dossier nommé <b>cymourai</b> avec une texture nommée <b>MaterialBase\_BaseColor.png</b> à l&#39;intérieur.
...
* <b>Maps d&#39;entrée</b> : canaux directs qui peuvent être ajoutés dans un jeu de textures. Via le panneau Paramètres de TextureSet.
* <b> Maps de maillage</b> : Textures présentes dans les emplacements de mappage supplémentaires d&#39;un Jeu de textures (textures bakées).
* <b> Mappages convertis :</b> textures virtuelles, générées lors de l&#39;exportation en fonction des canaux présents dans le document.
  * <b>Normal OpenGL/DirectX</b> : génère une normale dans l&#39;espace dédié en associant la normale à partir des cartes supplémentaires, de l&#39;height et du canal normal.
  * <b>AO mixte</b> : combinez le mappage supplémentaire d&#39;Ambient occlusion avec le canal d&#39;Ambient occlusion.
  * <b>Diffuse</b> : couleur de Diffuse générée à partir de la couleur de base et des couches Métalliques (les parties métalliques seront remplacées par une couleur noire).
  * <b>Specular</b> : couleur Specular générée à partir de la couleur de base et des couches Métallique.
  * <b>Brillance</b> : inverse du canal de rugosité.
  * <b>Diffuse Unity4</b> : couleur de Diffuse générée à partir de BaseColor pour correspondre aux nuanciers Unity4.
  * <b>Unity4 Gloss</b> : Brillance générée à partir de la Rugosité et du canal Métallique pour correspondre aux nuanceurs Unity4.
  ...
  * <b>Brillance<sup>2</sup></b> : version carrée du canal de brillance (Brillance \* Brillance)
