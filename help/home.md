...
Si vous avez une question à laquelle il n&#39;y a pas de réponse dans ce manuel, n&#39;hésitez pas à la poser sur notre [Forum](https://community.adobe.com/t5/substance-3d-painter/bd-p/substance-3d-painter). Vous pouvez également télécharger notre [guide Rendu physique réaliste](https://helpx.adobe.com/fr/substance-3d/unlisted/tutorials.html) si vous souhaitez en savoir plus sur le PBR.
...
* [Activation et licences](getting-started/activation-and-licenses.md) : cette page contient des informations sur l’activation et la gestion de vos licences afin que vous puissiez commencer à utiliser Painter.
* [Configuration requise](getting-started/system-requirements.md) : cette page regroupe les informations relatives à la configuration requise et à la compatibilité matérielle.
* [Création de projet](getting-started/project-creation.md) : la nouvelle fenêtre de création de projet permet de créer un fichier de projet pour stocker le modèle 3D et ses informations de texturation.
* [Exporter](export/export.md) — Un projet peut être exporté dans des textures bitmap à utiliser avec d&#39;autres logiciels. Il est également possible d’exporter la géométrie du modèle 3D.
* [Glossaire](getting-started/glossary.md) : cette page répertorie les mots-clés les plus courants utilisés par l&#39;application, ainsi qu&#39;une brève explication du concept qui la sous-tend.
* [Performances](technical-support/performances-guidelines/performances-guidelines.md) : cette page regroupe des conseils et des astuces sur la façon d&#39;optimiser les performances et de garantir un bon fonctionnement.

### Interface

* [Ressources](interface/assets/assets.md)
* [Sélecteur de couleurs](interface/color-picker.md)
* [Paramètres d’affichage](interface/display-settings/display-settings.md)
* [Historique](interface/history.md)
* [Pile de calques](interface/layer-stack/layer-stack.md)
* [Menu principal](interface/main-menu/main-menu.md)
* [Configuration du projet](interface/project-configuration.md)
* [Propriétés](interface/properties.md)
* [Paramètres](interface/settings/settings.md)
* [Paramètres du shader](interface/shader-settings/shader-settings.md)
* [Ensemble de textures](interface/texture-set/texture-set.md)
* [Barres d&#39;outils](interface/toolbars.md)
* [Viewport](interface/viewport/viewport.md)
...
* [Création d’effets personnalisés](content/creating-custom-effects/creating-custom-effects.md)
* [Importation d’actifs](https://helpx.adobe.com/fr/substance-3d/unlisted/documentation/spdoc/adding-content-to-the-shelf-142213317.html)
...
* [Installation et préférences](pipeline-and-integration/installation-and-pre/preferences-and-application-data-location.md)
* [Configuration](pipeline-and-integration/configuration/command-lines.md)
* [Gestion des ressources](pipeline-and-integration/resource-management/adding-resource-paths-edi/adding-resource-paths-by-editing-preferences-manually.md)

### Scripts et développement

* [Scripts et plug-ins](https://helpx.adobe.com/fr/substance-3d/unlisted/documentation/spdoc/script-and-plugins-197427392.html)
...
* [Toutes les modifications](release-notes/all-changes.md)
* [Version 11.1](release-notes/version-11-1.md)
* [Version 11.0](release-notes/version-11-0.md)
* [Version 10.1](release-notes/version-10-1.md)
