...
helpx_learn_topic: ""
helpx_tags: ""
title: Emplacement de l’Étagère et des ressources
...
# Emplacement de l’Étagère et des ressources

Cette page répertorie l’emplacement des ressources (ou de l’Étagère pour les anciennes versions) pour chaque plate-forme.Ce chemin d’accès est l’emplacement par défaut du contenu utilisateur (tel que l’enregistrement des paramètres prédéfinis dans la fenêtre Ressource) et des plug-ins.
