...
helpx_learn_topic: ""
helpx_tags: ""
title: Emplacement du rayon et des ressources
...
# Emplacement du rayon et des ressources

Cette page répertorie l’emplacement des ressources (ou une tablette pour les anciennes versions) pour chaque plateforme.Ce chemin d’accès est l’emplacement par défaut du contenu utilisateur (tel que l’enregistrement des paramètres prédéfinis dans la fenêtre Ressource) et des plug-ins.
