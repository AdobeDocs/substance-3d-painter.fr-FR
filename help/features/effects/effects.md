...
>[!NOTE]
>
> Vous pouvez cliquer avec le bouton droit de la souris sur un effet pour le réorganiser, mais vous pouvez également utiliser les touches ALT + Flèche Haut ou Flèche Bas pour les réorganiser rapidement.

Voici les différents types d’effets disponibles dans Substance 3D Painter :

* [Générateur](generator.md)
* [Peinture](paint.md)
* [Remplissage](fill.md)
* [Niveaux](levels.md)
* [Masque de comparaison](compare-mask.md)
* [Filtre](filter.md)
* [Point d’ancrage](anchor-point.md)
