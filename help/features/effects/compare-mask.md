...
breadcrumb-title: ''
description: Apprenez à utiliser l’effet Masque de comparaison de Substance 3D Painter pour créer des masques en fonction d’opérations de comparaison de textures.
...
| --- | --- |
| **Canal** | Canal à comparer entre la source et la cible à partir duquel créer un masque. Cette liste est basée sur le canal disponible dans les [paramètres de Jeu de textures](../../interface/texture-set/texture-set-settings.md). |
