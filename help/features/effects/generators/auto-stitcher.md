...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>Description</strong><br>Le générateur de raccordement automatique crée automatiquement un effet de raccordement le long des tracés générés selon les procédures. Ces chemins peuvent être générés en fonction des UV, de la Courbure ou d’une map d'entrée personnalisée.<br><br>Le générateur de raccordement automatique génère une texture monochrome (noir et blanc). Par conséquent, il est utile de générer des masques pour appliquer des effets de raccordement.<br><br>Pour utiliser le mode Masque de Courbure, une map curvature bakée est requise. <a href="../../../baking/baking.md">En savoir plus sur le baking ici</a>.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>Niveaux de gris de <strong>Courbure</strong></td>
    <td>Sélectionnez comment générer les tracés de raccordement :<br><ul><li><strong>Masque UV</strong> génère les tracés le long des UV.</li><li><strong>La Courbure </strong>génère des tracés près des bords nets.</li><li><strong>L'entrée personnalisée</strong> vous permet de contrôler où les chemins sont générés à l'aide d'un mappage.<br>Lors de l'utilisation de l'<strong>entrée personnalisée</strong>, les tracés sont générés dans des zones à contraste élevé.</li></ul></td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    ...
    <td>Sélectionnez le mode Masque.<br><ul><li>Masque UV : masques basés sur les Îlots UV.</li><li>Courbure : masque en fonction de la Map curvature.</li><li>Entrée personnalisée : masque selon une texture d’entrée personnalisée.</li></ul></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Réglez la variation dans la direction d’écoulement des points.</td>
  </tr>
</table>
