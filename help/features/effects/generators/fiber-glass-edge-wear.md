...
<table>
  ...
  <tr>
    ...
    <td>Inversez des cartes internes spécifiques (par exemple, Courbure, AO) avant de les combiner dans le masque final.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Réglez l’impact de la courbe d’ambient occlusion sur le résultat.</td>
  </tr>
  <tr>
    <td><strong>Poids de courbure</strong></td>
    <td>Réglez l’impact de la map curvature sur le résultat.</td>
  </tr>
</table>
