...
* Pour le **shader personnalisé** : examinez le ou les messages d&#39;erreur dans le journal ainsi que la page [API de shader](https://helpx.adobe.com/substance-3d/unlisted/documentation/spdoc/custom-shader-api-89686018.html).
