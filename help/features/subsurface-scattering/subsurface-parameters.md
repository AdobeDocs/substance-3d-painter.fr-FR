---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-painter/features/subsurface-scattering/subsurface-parameters.html"
breadcrumb-title: ''
description: Apprenez à configurer les paramètres de subsurface scattering dans Substance 3D Painter pour obtenir des matériaux translucides réalistes.
...
L’implémentation du sous-sol en temps réel de Substance 3D Painter est un effet de subsurface scattering d’espace d’écran. Les paramètres de contrôle sont expliqués dans cette page.\
La mise en œuvre actuelle est fondée sur la méthode [Profils de réflexion approximative pour une Subsurface scattering efficace» publiée par PIXAR](http://graphics.pixar.com/library/ApproxBSSRDF/).
...
Disponible dans la fenêtre [Paramètres de Shader](../../interface/shader-settings/shader-settings.md).

| *Paramètre* | *Description* |
| --- | --- |
| **Activer** | Activez ou désactivez l&#39;effet de Subsurface scattering sur cette instance de shader/mdl.  Peut être utilisé pour désactiver l’effet SSS sur les matériaux qui n’en ont pas besoin. |
...
| **Échelle** | Contrôle le rayon/la profondeur de l’absorption lumineuse dans le matériau. Le comportement de ce paramètre change en fonction de la taille du maillage dans la scène.Comparaison entre une échelle de 0,0, 0,2 et 1,0 sur une tête de taille humaine :   <div><img data-preserve-html="true" src="../../assets/scale-sss.jpg" width="650"/></div> |
