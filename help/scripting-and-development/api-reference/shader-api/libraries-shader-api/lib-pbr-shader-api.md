...
# Lib PBR - API de shader

## lib-pbr.glsl

**Fonctions publiques :** *normal\_distrib* *fresnel* *G1* *visibilité* *horizonFading* *pbrComputeDiffuse* *pbrComputeSpecular* *pbrComputeBRDF*

Nombre de niveaux dans le mappage d&#39;enveloppe.
...
Valeur utilisée pour contrôler la fuite de réflexion du specular à travers la surface.
...
Importation à partir de la bibliothèque, autres paramètres
...
Astuce de fondu horizontal de <https://marmosetco.tumblr.com/post/81245981087>
...
Calculer la radiance diffuse lambertienne pour l&#39;œil de l&#39;observateur
...
Calculer le reflet du specular des microfacettes à l&#39;œil de l&#39;observateur
