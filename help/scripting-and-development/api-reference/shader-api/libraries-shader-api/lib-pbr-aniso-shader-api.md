---
helpx_url: "https://helpx.adobe.com/fr/substance-3d-painter/scripting-and-development/api-reference/shader-api/libraries-shader-api/lib-pbr-aniso-shader-api.html"
breadcrumb-title: ''
description: Accédez à la référence Lib PBR Aniso API de shader pour Substance 3D Painter afin de créer des matériaux anisotropes basés physiquement.
...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib PBR Aniso - API de shader
...
# Lib PBR Aniso - API de shader

## lib-pbr-aniso.glsl

**Fonctions publiques :** *normal\_distrib* *G1* *visibilité* *cook\_torrance\_contrib* *importanceSampleGGX* *probabilitéGGX* *pbrComputeSpecularAnisotropic*
