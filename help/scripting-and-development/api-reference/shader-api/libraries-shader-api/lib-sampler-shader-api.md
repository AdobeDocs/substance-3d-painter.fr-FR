...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib Sampler - API de shader
...
# Lib Sampler - API de shader

## lib-sampler.glsl

**Fonctions publiques :** *getAO* *getShadowFactor* *getGlossiness* *getRoughness* *getMetallic* *getAnisotropyLevel* *getAnisotropyAngle* *getOpacity* *getHeight* *getDisplacement* *getSpecularLevel* *getBaseColor* *getDiffuse* *getSpecularColor* *getScattering* *generateAnisotropicRoughness* *generateDiffuseColor* *generateSpecularColor*
...
Couleurs d’arrière-plan par défaut en l’absence de données dans la couche (alpha = 0)
...
Renvoyer la brillance échantillonnée ou une valeur par défaut
...
Renvoyer la rugosité échantillonnée ou une valeur par défaut
...
Renvoyer l’opacité échantillonnée ou une valeur par défaut
...
Renvoyer l’height échantillonné ou une valeur par défaut
...
Renvoyer le displacement échantillonné ou une valeur par défaut
...
Récupérer le facteur d’ombrage (espace-écran)
...
Renvoyer la couleur diffuse échantillonnée ou une valeur par défaut
...
Renvoyer la couleur de specular échantillonnée ou une valeur par défaut
...
Renvoyer la valeur de diffusion échantillonnée ou une valeur par défaut
