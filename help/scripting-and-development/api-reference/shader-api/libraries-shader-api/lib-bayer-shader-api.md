...
breadcrumb-title: ''
description: Accédez à la référence Lib Bayer API de shader pour Substance 3D Painter afin de créer des motifs Bayer dithering dans des shaders personnalisés.
